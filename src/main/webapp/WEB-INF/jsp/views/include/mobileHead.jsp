...
<!-- css -->
<link href="/assets/css/mobile/swiper.css" type="text/css" rel="stylesheet" media="all">
...
<link href="/assets/css/mobile/style.css" type="text/css" rel="stylesheet" media="all">
