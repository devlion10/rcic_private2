...
<html lang="ko" class="mapHtml">
    <head>
	 ...
	 <jsp:include page="/WEB-INF/jsp/views/include/htmlHead.jsp"></jsp:include>
	    ...
	    <script type="text/javascript" src="http://dapi.kakao.com/v2/maps/sdk.js?appkey=${kakaoMapApiKey}"></script>
				...
				<div class="mapNavBox">
					<div class="mapSLBox">
						<div class="navLeftTop">
							<div class="navTop">
								<div class="inline"><a href="/"><img src="/assets/images/map/map_rcicLogo.png" alt="logo"></a></div>
								<!-- <div class="inline">
							...
							<div class="navLeftTab">
								<div class="inline">
									<span class="active" data-index="1">검색</span>
								</div>
								<div class="inline">
