                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="file"   name="shpFiles" id="shpFile" multiple="multiple" accept=".zip"/><br>
                                    * 연속지적 데이터 압축(zip) 파일을 선택하세요.
                                </td>
                            </tr>
                        </table>
                    </div>
...
<script type="text/javascript">
        ...
        $('#dataimport').on('show.bs.modal', function (event) {
        	//alert($(event.relatedTarget).data().dicTblNm);
       		...
       		switch($(event.relatedTarget).data().dicTblNm){
       			case "tb_cbnd_info_all" : 
       				document.getElementById("modal_sub").innerHTML = "_전체"
       				break;
       			case "tb_cbnd_info_change" : 
       				document.getElementById("modal_sub").innerHTML = "_변동분"
       				break;
       		}
    ...
    var modalDataImport = {
        ...
        save: function () {
            ...
            if (exts.indexOf('zip') == -1 ) {
                alert('업로드 데이터는 zip 파일을 포함해야 합니다.');
                return;
            }
            ...
            var url;
            switch(formData.get('dicTblNm')){
            	case "tb_cbnd_all" : 
            		url = "/admin/dic/cbnd/import"
            	break;
            	case "tb_cbnd_change" : 
            		url = "/admin/dic/cbnd/change"
            	break; 
            }
