        ...
        <div class="col-md-12">
            <div class="content-panel">
                ...
                <div class="col-md-12 searchMB">
                    <form class="form-inline" role="form" id="searchForm">
                        ...
                        <div class="form-group mr10">
                            <input type="text" class="form-control" placeholder="표준노드링크명" name="road_name">
                        </div>
                ...
                <div class="total">
                    ...
                    <button type="button" class="btn btn-theme04 btnSearch" data-toggle="modal" data-target="#dataimport" data-dic-nm="표준노드링크" data-dic-tbl-nm="tl_moct_link_line">데이터 업로드</button>
                </div>
...
<script type="text/javascript">
    ...
    function retrieve(currPage) {
        ...
        var collection = "tl_moct_link_line";
    ...
    function createRow(item) {
        var $tr = $('<tr/>')
            ...
            .append($('<td/>').txt(item.li_nm  )) // 리
            .append($('<td/>').txt(item.road_name)) // 표준노드링크명
            .append($('<td/>').txt(item.ref_nm)) // 관련링크
        return $tr;
    }
</script>
</c:set>