            ...
            <div class="content-panel">
                ...
                <div class="col-md-12 searchMB">
                    <form class="form-inline" role="form" id="searchForm">
                        ...
                        <button type="button" class="btn btn-success searchBtn" id="btnDataCntcKrris">도로대장49종 전체분 연계</button> 
                    </form>
                </div>
                <div class="total">
...
<script type="text/javascript">
    ...
    function initEvent3() {
		...
		document.getElementById('btnDataCntcChange').addEventListener('click', function(event){
			...
			$.ajax({
                type: 'get',
                url: '/admin/dic/road-name/DataCntcChange2',
                data: param,
                contentType: 'application/json'
            }).done(function (res) {
            	alert("Done!!");
    ...
    function initEvent4() {
		document.getElementById('btnDataCntcKrris').addEventListener('click', function(event){
            var param = {
                };
            
			$.ajax({
                type: 'get',
                url: '/admin/dic/getLayerInfo',
                data: param,
                contentType: 'application/json'
            }).done(function (res) {
            	alert("Done!!");
